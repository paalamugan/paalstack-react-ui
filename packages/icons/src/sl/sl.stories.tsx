...
export function SimpleLineIcons() {
  const icons = React.useMemo(() => toIconEntries(SlIcons), []);
  ...
  return (
    <VStack className="gap-6">
      <Input placeholder="Search Simple Line icons..." onChange={onValueChange} />
      <VStack className="mb-6">
        <Heading as="h2">Simple Line Icons ({filteredIcons.length})</Heading>
