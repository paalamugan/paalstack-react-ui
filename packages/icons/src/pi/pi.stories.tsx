...
export function PhosphorIcons() {
  const icons = React.useMemo(() => toIconEntries(PiIcons), []);
  ...
  return (
    <VStack className="gap-6">
      <Input placeholder="Search Phosphor icons..." onChange={onValueChange} />
      <VStack className="mb-6">
        <Heading as="h2">Phosphor Icons ({filteredIcons.length})</Heading>
