...
import * as MdIcons from './index';
import { MdFavorite, MdHome, MdSearch } from './index';
...
export default {
  title: 'Icons/Material Design Icons',
  tags: ['autodocs'],
  parameters: {
  ...
  return (
    <IconUsageExamples
      ...
      exampleIcons={{
        ...
        icon1Name: 'MdHome',
        icon2Name: 'MdSearch',
        icon3Name: 'MdFavorite',
      }}
    />
  );
}

export function MaterialDesignIcons() {
  const icons = React.useMemo(() => toIconEntries(MdIcons), []);
  ...
  return (
    <VStack className="gap-6">
      <Input placeholder="Search Material Design icons..." onChange={onValueChange} />
      <VStack className="mb-6">
        <Heading as="h2">Material Design Icons ({filteredIcons.length})</Heading>
