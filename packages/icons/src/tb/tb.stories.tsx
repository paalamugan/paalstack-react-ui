...
export function TablerIcons() {
  const icons = React.useMemo(() => toIconEntries(TbIcons), []);
  ...
  return (
    <VStack className="gap-6">
      <Input placeholder="Search Tabler icons..." onChange={onValueChange} />
      <VStack className="mb-6">
        <Heading as="h2">Tabler Icons ({filteredIcons.length})</Heading>
