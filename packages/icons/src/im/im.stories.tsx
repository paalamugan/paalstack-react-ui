...
export function IcoMoonFree() {
  const icons = React.useMemo(() => toIconEntries(ImIcons), []);
  ...
  return (
    <VStack className="gap-6">
      <Input placeholder="Search IcoMoon Free icons..." onChange={onValueChange} />
      <VStack className="mb-6">
        <Heading as="h2">IcoMoon Free Icons ({filteredIcons.length})</Heading>
