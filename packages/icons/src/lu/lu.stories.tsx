...
import * as LuIcons from './index';
import { LuHeart, LuHouse, LuStar } from './index';
...
export function LucideIcons() {
  const icons = React.useMemo(() => toIconEntries(LuIcons), []);
  ...
  return (
    <VStack className="gap-6">
      <Input placeholder="Search Lucide icons..." onChange={onValueChange} />
      <VStack className="mb-6">
        <Heading as="h2">Lucide Icons ({filteredIcons.length})</Heading>
