...
export function RemixIcons() {
  const icons = React.useMemo(() => toIconEntries(RiIcons), []);
  ...
  return (
    <VStack className="gap-6">
      <Input placeholder="Search Remix icons..." onChange={onValueChange} />
      <VStack className="mb-6">
        <Heading as="h2">Remix Icons ({filteredIcons.length})</Heading>
