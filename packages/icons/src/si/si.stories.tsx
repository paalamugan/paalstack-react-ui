...
export function SimpleIcons() {
  const icons = React.useMemo(() => toIconEntries(SiIcons), []);
  ...
  return (
    <VStack className="gap-6">
      <Input placeholder="Search Simple icons..." onChange={onValueChange} />
      <VStack className="mb-6">
        <Heading as="h2">Simple Icons ({filteredIcons.length})</Heading>
