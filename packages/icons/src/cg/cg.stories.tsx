...
export function CssGgIcons() {
  const icons = React.useMemo(() => toIconEntries(CgIcons), []);
  ...
  return (
    <VStack className="gap-6">
      <Input placeholder="Search css.gg icons..." onChange={onValueChange} />
      <VStack className="mb-6">
        <Heading as="h2">css.gg Icons ({filteredIcons.length})</Heading>
