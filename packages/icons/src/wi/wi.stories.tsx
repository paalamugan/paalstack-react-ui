...
export function WeatherIcons() {
  const icons = React.useMemo(() => toIconEntries(WiIcons), []);
  ...
  return (
    <VStack className="gap-6">
      <Input placeholder="Search Weather icons..." onChange={onValueChange} />
      <VStack className="mb-6">
        <Heading as="h2">Weather Icons ({filteredIcons.length})</Heading>
