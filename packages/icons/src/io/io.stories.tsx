...
export function Ionicons4() {
  const icons = React.useMemo(() => toIconEntries(IoIcons), []);
  ...
  return (
    <VStack className="gap-6">
      <Input placeholder="Search Ionicons 4..." onChange={onValueChange} />
      <VStack className="mb-6">
        <Heading as="h2">Ionicons 4 ({filteredIcons.length})</Heading>
