...
export function Devicons() {
  const icons = React.useMemo(() => toIconEntries(DiIcons), []);
  ...
  return (
    <VStack className="gap-6">
      <Input placeholder="Search Devicons..." onChange={onValueChange} />
      <VStack className="mb-6">
        <Heading as="h2">Devicons ({filteredIcons.length})</Heading>
