...
export function BootstrapIcons() {
  const icons = React.useMemo(() => toIconEntries(BsIcons), []);
  ...
  return (
    <VStack className="gap-6">
      <Input placeholder="Search Bootstrap icons..." onChange={onValueChange} />
      <VStack className="mb-6">
        <Heading as="h2">Bootstrap Icons ({filteredIcons.length})</Heading>
