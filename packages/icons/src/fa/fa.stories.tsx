...
export function FontAwesome() {
  const icons = React.useMemo(() => toIconEntries(FaIcons), []);
  ...
  return (
    <VStack className="gap-6">
      <Input placeholder="Search Font Awesome icons..." onChange={onValueChange} />
      <VStack className="mb-6">
        <Heading as="h2">Font Awesome ({filteredIcons.length})</Heading>
