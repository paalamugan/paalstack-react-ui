...
export function Typicons() {
  const icons = React.useMemo(() => toIconEntries(TiIcons), []);
  ...
  return (
    <VStack className="gap-6">
      <Input placeholder="Search Typicons..." onChange={onValueChange} />
      <VStack className="mb-6">
        <Heading as="h2">Typicons ({filteredIcons.length})</Heading>
