...
export function AntDesignIcons() {
  const icons = React.useMemo(() => toIconEntries(AiIcons), []);
  ...
  return (
    <VStack className="gap-6">
      <Input placeholder="Search Ant Design icons..." onChange={onValueChange} />
      <VStack className="mb-6">
        <Heading as="h2">Ant Design Icons ({filteredIcons.length})</Heading>
