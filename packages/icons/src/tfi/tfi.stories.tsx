...
export function ThemifyIcons() {
  const icons = React.useMemo(() => toIconEntries(TfiIcons), []);
  ...
  return (
    <VStack className="gap-6">
      <Input placeholder="Search Themify icons..." onChange={onValueChange} />
      <VStack className="mb-6">
        <Heading as="h2">Themify Icons ({filteredIcons.length})</Heading>
