...
import * as Hi2Icons from './index';
import { HiHeart, HiHome, HiStar } from './index';
...
export function Heroicons2() {
  const icons = React.useMemo(() => toIconEntries(Hi2Icons), []);
  ...
  return (
    <VStack className="gap-6">
      <Input placeholder="Search Heroicons 2..." onChange={onValueChange} />
      <VStack className="mb-6">
        <Heading as="h2">Heroicons 2 ({filteredIcons.length})</Heading>
