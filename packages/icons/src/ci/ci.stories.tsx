...
export function CircumIcons() {
  const icons = React.useMemo(() => toIconEntries(CiIcons), []);
  ...
  return (
    <VStack className="gap-6">
      <Input placeholder="Search Circum icons..." onChange={onValueChange} />
      <VStack className="mb-6">
        <Heading as="h2">Circum Icons ({filteredIcons.length})</Heading>
