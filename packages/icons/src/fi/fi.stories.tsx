...
export function FeatherIcons() {
  const icons = React.useMemo(() => toIconEntries(FiIcons), []);
  ...
  return (
    <VStack className="gap-6">
      <Input placeholder="Search Feather icons..." onChange={onValueChange} />
      <VStack className="mb-6">
        <Heading as="h2">Feather Icons ({filteredIcons.length})</Heading>
