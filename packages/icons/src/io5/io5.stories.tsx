...
export function Ionicons5() {
  const icons = React.useMemo(() => toIconEntries(Io5Icons), []);
  ...
  return (
    <VStack className="gap-6">
      <Input placeholder="Search Ionicons 5..." onChange={onValueChange} />
      <VStack className="mb-6">
        <Heading as="h2">Ionicons 5 ({filteredIcons.length})</Heading>
