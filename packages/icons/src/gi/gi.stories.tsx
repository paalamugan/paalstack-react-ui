...
export function GameIcons() {
  const icons = React.useMemo(() => toIconEntries(GiIcons), []);
  ...
  return (
    <VStack className="gap-6">
      <Input placeholder="Search Game icons..." onChange={onValueChange} />
      <VStack className="mb-6">
        <Heading as="h2">Game Icons ({filteredIcons.length})</Heading>
