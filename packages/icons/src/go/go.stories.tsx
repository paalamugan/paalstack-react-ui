...
export function GithubOcticons() {
  const icons = React.useMemo(() => toIconEntries(GoIcons), []);
  ...
  return (
    <VStack className="gap-6">
      <Input placeholder="Search Github Octicons..." onChange={onValueChange} />
      <VStack className="mb-6">
        <Heading as="h2">Github Octicons ({filteredIcons.length})</Heading>
