...
export function FlatColorIcons() {
  const icons = React.useMemo(() => toIconEntries(FcIcons), []);
  ...
  return (
    <VStack className="gap-6">
      <Input placeholder="Search Flat Color icons..." onChange={onValueChange} />
      <VStack className="mb-6">
        <Heading as="h2">Flat Color Icons ({filteredIcons.length})</Heading>
