...
export function BoxIcons() {
  const icons = React.useMemo(() => toIconEntries(BiIcons), []);
  ...
  return (
    <VStack className="gap-6">
      <Input placeholder="Search BoxIcons..." onChange={onValueChange} />
      <VStack className="mb-6">
        <Heading as="h2">BoxIcons ({filteredIcons.length})</Heading>
