...
export function VSCodeIcons() {
  const icons = React.useMemo(() => toIconEntries(VscIcons), []);
  ...
  return (
    <VStack className="gap-6">
      <Input placeholder="Search VS Code icons..." onChange={onValueChange} />
      <VStack className="mb-6">
        <Heading as="h2">VS Code Icons ({filteredIcons.length})</Heading>
