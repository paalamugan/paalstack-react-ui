...
export function LineAwesome() {
  const icons = React.useMemo(() => toIconEntries(LiaIcons), []);
  ...
  return (
    <VStack className="gap-6">
      <Input placeholder="Search Line Awesome icons..." onChange={onValueChange} />
      <VStack className="mb-6">
        <Heading as="h2">Line Awesome Icons ({filteredIcons.length})</Heading>
