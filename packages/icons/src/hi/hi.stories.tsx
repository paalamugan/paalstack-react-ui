...
export function Heroicons() {
  const icons = React.useMemo(() => toIconEntries(HiIcons), []);
  ...
  return (
    <VStack className="gap-6">
      <Input placeholder="Search Heroicons..." onChange={onValueChange} />
      <VStack className="mb-6">
        <Heading as="h2">Heroicons ({filteredIcons.length})</Heading>
