...
import { LuPanelLeft as PanelLeftIcon } from '@/icons/lu';
...
const SidebarProvider = ({
  ...
  const isMobile = useMediaQuery('(max-width: 768px)', false, { getInitialValueInEffect: true }) ?? false;
...
const SidebarInput = ({ className, ...props }: React.ComponentProps<typeof Input>) => {
  return (
    <Input
      ...
      data-qa="sidebar-input"
      inputClassName={cn('h-8 w-full bg-background shadow-none', className)}
      {...props}
    />
  );
};
...
const SidebarMenuSubButton = ({
  ...
  return (
    <Comp
      ...
      data-qa="sidebar-menu-sub-button"
      data-active={isActive}
      className={cn(
