...
const NavigationMenuViewport = ({
  ...
  <div className={cn('absolute top-full left-0 flex justify-center')}>
    <NavigationMenuPrimitive.Viewport
      className={cn(
        'origin-top-center relative mt-1.5 w-full overflow-hidden rounded-lg border bg-popover text-popover-foreground shadow ring-1 ring-foreground/10 data-closed:animate-out data-closed:zoom-out-95 data-open:animate-in data-open:zoom-in-90',
        className,
      )}
