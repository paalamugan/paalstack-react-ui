...
import { CartesianGrid, Dot, LabelList, Line, LineChart as RechartsLineChart, XAxis } from 'recharts';

import { LuGitCommitVertical, LuTrendingUp } from '@/icons/lu';
...
export const Dots: Story = {
  render: () => (
    <Card>
      ...
      <CardContent>
        <ChartContainer config={dotsChartConfig} className="max-h-[250px] min-h-[200px] w-full">
          <RechartsLineChart
            accessibilityLayer
            data={dotsChartData}
            margin={{
...
export const DotsCustom: Story = {
  render: () => (
    <Card>
      ...
      <CardContent>
        <ChartContainer config={customDotsChartConfig} className="max-h-[250px] min-h-[200px] w-full">
          <RechartsLineChart
            accessibilityLayer
            data={customDotsChartData}
            margin={{
              left: 12,
              right: 12,
            }}
...
// Line Chart with Dots Colors
const dotsColorsChartData = [
...
export const DotsColors: Story = {
  render: () => (
    <Card>
      ...
      <CardContent>
        <ChartContainer config={dotsColorsChartConfig} className="max-h-[250px] min-h-[200px] w-full">
          <RechartsLineChart
            accessibilityLayer
            data={dotsColorsChartData}
            margin={{
              top: 24,
              left: 24,
              right: 24,
          ...
          >
            ...
            >
              <LabelList
                ...
                dataKey="browser"
                formatter={(value) =>
                  value && typeof value === 'string' && value in customLabelChartConfig
                    ? customLabelChartConfig[value as keyof typeof customLabelChartConfig]?.label
                    : value
                }
              />
            </Line>
