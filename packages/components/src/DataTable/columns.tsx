...
import type { DataTableActionItem, DataTableColumnDef } from './types';

import { RxTrash as TrashIcon } from '@/icons/rx';
...
const actionColumnItems: DataTableActionItem[] = [
  {
    label: 'Edit',
    value: 'edit',
  },
...
export const columns: DataTableColumnDef<Task>[] = [
  ...
  {
    id: 'actions',
    cell: ({ row }) => <DataTableRowActions row={row} rowSchema={taskSchema} actionItems={actionColumnItems} />,
  },
];
