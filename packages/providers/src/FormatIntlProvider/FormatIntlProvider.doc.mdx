...
```tsx
import { useFormatIntl } from '@paalstack/react-providers';
...
```tsx
import { Box, Text } from '@paalstack/react-layouts';
import { FormatIntlProvider, useFormatIntl } from '@paalstack/react-providers';
