...
import { Box, Text, VStack } from '@/layouts/index';
...
export function WithSiblings() {
  return (
    <VStack>
      <Box>
        <Text className="mb-4">1 sibling (default)</Text>
        <Pagination total={200} siblings={1} initialPage={10} />
      </Box>
      <Box>
        <Text className="mb-4">2 siblings</Text>
        <Pagination total={200} siblings={2} initialPage={10} />
      </Box>
      <Box>
        <Text className="mb-4">3 siblings</Text>
...
export function WithBoundaries() {
  return (
    <VStack>
      <Box>
        <Text className="mb-4">1 boundary (default)</Text>
        <Pagination total={200} boundaries={1} initialPage={10} />
      </Box>
      <Box>
        <Text className="mb-4">2 boundaries</Text>
        <Pagination total={200} boundaries={2} initialPage={10} />
      </Box>
      <Box>
        <Text className="mb-4">3 boundaries</Text>
