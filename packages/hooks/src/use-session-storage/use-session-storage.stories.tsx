...
import { Box, Flex, Stack, TypographyP, TypographyStrong } from '@/layouts/index';
...
export function Usage() {
  ...
  return (
    <div className="p-6">
      ...
      <TypographyP>
        <TypographyStrong>Session Value</TypographyStrong>: {value}
      </TypographyP>
    </div>
  );
}
...
export function SerializeJson() {
  ...
  return (
    <Stack className="p-20" direction="column">
