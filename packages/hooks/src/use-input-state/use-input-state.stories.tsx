...
import { Input, NumberInput } from '@/components/index';
import { Stack } from '@/layouts/index';
...
export function Usage() {
  ...
  return (
    <Stack>
      ...
      <Input label="Label" value={stringValue} onValueChange={setStringValue} placeholder="Enter a Text" />
